const quizzDataBaseSource = {
  ...
  'a56abb5d-612d-4105-9505-6db7e8f1d23c': {
    ...
    options: [
      {
        text: '<img src="http://lorempixel.com/350/250/cats/" alt=\u201DCat Adventures\u201D>',
      },
      ...
      {
        text: '<img src="data:image/jpeg;base64,/9j/4RiD..." width="150"  height="150">',
      },
      {
        text: '<image src="horse.jpg" width="250" height="250" alt="My little pony">',
      },
    ],
    solutions: [0, 3],
    language: 'html',
  ...
  '4bed0ba0-c25b-4911-8f3c-d2634ee0775d': {
    ...
    options: [
      ...
      {
        text: 'Margin allows us to set the amount of space that surrounds an element.',
      },
      {
        text: 'Padding allows us to set the amount of space that surrounds an element.',
      },
      {
  ...
  'jfads8-1056-484d-8a1c-fd2580019ea3': {
    ...
    language: 'javascript',
    options: [{ text: '13' }, { text: '18' }, { text: '22' }],
    solutions: [0],
  },
...
export default quizzDataBaseSource;
